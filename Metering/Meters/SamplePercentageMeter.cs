...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class SamplePercentageMeter : Meter, ISamplePercentage
    {
        ...
        public SamplePercentageMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, InstanceLifetime instanceLifetime)
