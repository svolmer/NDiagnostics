...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class AverageTimeMeter : Meter, IAverageTime
    {
        ...
        public AverageTimeMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, MeterInstanceLifetime instanceLifetime = MeterInstanceLifetime.Global)
