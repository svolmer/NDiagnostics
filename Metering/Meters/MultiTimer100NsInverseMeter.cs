...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class MultiTimer100NsInverseMeter : Meter, IMultiTimer100NsInverse
    {
        ...
        public MultiTimer100NsInverseMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, MeterInstanceLifetime instanceLifetime = MeterInstanceLifetime.Global)
