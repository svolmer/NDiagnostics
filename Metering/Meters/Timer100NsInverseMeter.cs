...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class Timer100nsInverseMeter : Meter, ITimer100NsInverse
    {
        ...
        public Timer100nsInverseMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, MeterInstanceLifetime instanceLifetime = MeterInstanceLifetime.Global)
