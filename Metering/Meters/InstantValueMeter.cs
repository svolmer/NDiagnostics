...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class InstantValueMeter : Meter, IInstantValue
    {
        ...
        public InstantValueMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, MeterInstanceLifetime instanceLifetime = MeterInstanceLifetime.Global)
