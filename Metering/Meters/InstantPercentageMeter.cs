...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class InstantPercentageMeter : Meter, IInstantPercentage
    {
        ...
        public InstantPercentageMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, InstanceLifetime instanceLifetime)
