...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class TimerInverseMeter : Meter, ITimerInverse
    {
        ...
        public TimerInverseMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, InstanceLifetime instanceLifetime = InstanceLifetime.Global)
