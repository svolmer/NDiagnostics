...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class MultiTimerInverseMeter : Meter, IMultiTimerInverse
    {
        ...
        public MultiTimerInverseMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, InstanceLifetime instanceLifetime = InstanceLifetime.Global)
