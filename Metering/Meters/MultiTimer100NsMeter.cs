...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class MultiTimer100NsMeter : Meter, IMultiTimer100Ns
    {
        ...
        public MultiTimer100NsMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, MeterInstanceLifetime instanceLifetime = MeterInstanceLifetime.Global)
