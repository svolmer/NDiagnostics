...
{
    internal sealed class MultiTimer100NsMeter : Meter<MultiTimer100NsSample>, IMultiTimer100Ns
    {
        ...
        public override MultiTimer100NsSample Current => this.GetCurrentSample();
