...
namespace NDiagnostics.Metering.Meters
{
    internal sealed class SampleRateMeter : Meter, ISampleRate
    {
        ...
        public SampleRateMeter(string categoryName, MeterCategoryType categoryType, string meterName, MeterType meterType, string instanceName, MeterInstanceLifetime instanceLifetime = MeterInstanceLifetime.Global)
