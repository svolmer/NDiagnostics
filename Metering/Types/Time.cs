...
namespace NDiagnostics.Metering.Types
{
    ...
    public struct Time : IComparable, IComparable<Time>, IEquatable<Time>
    {
        ...
        public static implicit operator Time100Ns(Time time)
        {
            return new Time100Ns(time.Seconds);
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if(!(obj is Time))
            {
                throw new ArgumentException("Object is not a Time.", "obj");
            }
